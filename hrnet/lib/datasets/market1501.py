...
class Market1501(BaseDataset):
    def __init__(self,
        ...
        super(Market1501, self).__init__(ignore_label, base_size,
        ...
        self.train_dir = os.path.join(self.root, 'market1501', 'bounding_box_train')
        self.query_dir = os.path.join(self.root, 'market1501', 'query')
        self.gallery_dir = os.path.join(self.root, 'market1501', 'bounding_box_test')
